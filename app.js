...
// connect to the DB
let url = process.env.DATABASEURL || "'mongodb+srv://ram-rajani:gocashless@cluster0-dnfuy.mongodb.net/test?retryWrites=true&w=majority'"; // fallback in case global var not working
